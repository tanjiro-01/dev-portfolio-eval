...
const ReportLayout = ({ report }) => {
  ...
  return (
    <div className="@container w-full">
      <div className="grid gap-4 @2xl:gap-6 grid-cols-1 @2xl:grid-cols-2 @5xl:grid-cols-3 @6xl:grid-cols-4 mt-6">
        <section className="bg-slate-900/80 backdrop-blur-md border border-slate-800 rounded-2xl p-6 col-span-full flex flex-col @2xl:flex-row items-center @2xl:items-start gap-6 shadow-xl relative overflow-hidden group">
        ...
        <div className="col-span-full @6xl:col-span-2">
          <ScoreSummary scores={report.scores} />
        </div>
        <div className="col-span-full @2xl:col-span-1 @6xl:col-span-2">
          <RadarBreakdown scores={report.scores} />
        </div>
        <div className="col-span-full @6xl:col-span-1">
          <ScoringMethodology />
        </div>
        <div className="col-span-full @6xl:col-span-3">
          <LanguageBars languages={report.languages} />
        </div>
        <div className="col-span-full @6xl:col-span-2 h-full">
