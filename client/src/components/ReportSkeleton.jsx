...
const ReportSkeleton = () => {
  return (
    <section className="@container w-full mx-auto flex flex-col gap-6" aria-busy="true" aria-live="polite">
      ...
      <section className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 flex flex-col @2xl:flex-row items-center gap-6">
      ...
      <div className="grid grid-cols-1 @4xl:grid-cols-2 gap-6 mt-4">
