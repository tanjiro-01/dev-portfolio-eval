    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-4 sm:p-8 bg-slate-950 relative overflow-hidden">
      ...
      <div className="w-full max-w-3xl relative z-10 flex flex-col gap-10">
        ...
        <section className="bg-slate-900/30 backdrop-blur-md border border-slate-800/60 rounded-3xl p-6 sm:p-8 shadow-xl text-center w-full max-w-2xl mx-auto relative group">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-3xl blur opacity-0 group-hover:opacity-100 transition duration-1000"></div>
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center mb-6">
              ...
              <button
                className="bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-500 hover:to-cyan-400 text-white rounded-xl px-6 py-3 font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-blue-500/20"
                type="button"
                onClick={openCompare}
                ...
                <div className="flex flex-wrap gap-2">
                  {savedPresets.map((preset) => (
                    <button
                      key={preset.id}
                      type="button"
                      className="bg-slate-800 border border-slate-700 hover:border-cyan-500 hover:text-cyan-300 text-slate-300 rounded-lg px-4 py-2 text-sm transition-colors"
                      onClick={() =>
